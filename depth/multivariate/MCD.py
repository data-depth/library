...
def MCD(data, h, seed=None, mfull = 10, nstep = 7, hiRegimeCompleteLastComp = True):
    ...
    libr.MinimumCovarianceDeterminantEstim(points, numPoints, dimension, hParam, seed, mat_MCD,c_chisqr05,c_chisqr0975,c_mfull,c_nstep,c_hiRegimeCompleteLastComp,c_seeded)
...
Arguments
    ...
    h
        Parameter for size of index set
