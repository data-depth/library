...
private:
	...
	int _nRandom = 10000;            // number of directions
	...
	std::vector<std::vector<double>> _Directions;  // vector containing the projection vectors considerd so far
...
public:
	// constructor
	cProjection(const dyMatrixClass::cMatrix& x, int n = 0, int d = 0, int NRandom = 10000);
	// destructor
	~cProjection();
